...
class WebSocketClient:
    ...
    def _parse_tick(self, tick_dict: Dict) -> TickData:
        ...
        return TickData(
            ...
            last_traded_quantity=tick_dict.get('last_traded_quantity'),
            average_traded_price=tick_dict.get('average_traded_price'),
            volume_traded=tick_dict.get('volume_traded'),
